...
# Temporary workaround: the below 2 lines will allow 'import cv2 as cv' to work, but then 
# I won't be able to work with ROS and python3 in the same environment...
import sys
