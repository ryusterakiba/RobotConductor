...
def main():
    ...
    planner.add_box_obstacle(box_size, "obstacle1", box_pose)
    """
    ...
    while not rospy.is_shutdown():
        ...
        while not rospy.is_shutdown():
            try:
                ...
                goal_1.pose.orientation.x = -0.033
                goal_1.pose.orientation.y = 0.730
                goal_1.pose.orientation.z = -0.066
                goal_1.pose.orientation.w = 0.680
